...
%text(.03,-.74,'\fontname{times}\fontsize{14}\itb')
%text(.03,.76,'\fontname{times}\fontsize{14}\ita')
...
G=[G1,G2];
hold on
plot(G/6,'-','linewidth',2)
plot(G2(1)/6,'.','markersize',20,'color','y')
plot(G2(end)/6,'.','markersize',20,'color','r')
line([-.5 -.5],[-.05 .05],'color','k')
line([-.05 .05],[-.5 -.5],'color','k')
line([-.05 .05],[.5 .5],'color','k')
line([.5 .5],[-.05 .05],'color','k')
text(-.54,-.1,'\fontname{times}\fontsize{14}-3')
text(.5,-.1,'\fontname{times}\fontsize{14}3')
