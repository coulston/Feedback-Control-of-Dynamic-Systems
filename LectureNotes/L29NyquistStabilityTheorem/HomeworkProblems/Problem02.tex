...
\]
\begin{enumerate}[(a)]
\item Using \textsc{Matlab}, find the Bode plots for $K=50$ and $K=500$.   Include both plots as your answer to this part of the question.
\item By hand, sketch the Nyquist plots for each case, and evaluate if the closed loop system is stable.
\end{enumerate}
