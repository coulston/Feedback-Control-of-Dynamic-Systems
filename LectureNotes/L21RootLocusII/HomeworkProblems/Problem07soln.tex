...
Decreasing the gain $K_p$ will move the closed-loop poles close to the open loop poles, which moves them closer to the real axis in this case and will decrease the percent overshoot. A derivative term also tends to increase damping and can therefore decrease overshoot; this term will change the shape of the root locus because it adds a zero.
