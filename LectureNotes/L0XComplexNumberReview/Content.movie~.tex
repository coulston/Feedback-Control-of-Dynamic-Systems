...
\tryit{\input{figures/complexplane.movie}}{\input{figures/complexplane1.movie}}
\end{column}
...
\resizebox{1.75in}{!}{\input{figures/complexplane2.movie}}
\end{center}
\tryit{\vspace{.75in}}{
\begin{align*}
a=&r\cos(\theta), \\
...
\tryit{\vspace{3in}}{\input{examplesolutions/polar1}
}
\end{frame}
...
$\frac{(1+j)(2+2j)}{3+4j}$\vspace{.2in}
\tryit{\vspace{3in}}{\input{examplesolutions/polar3}
}
\end{frame}
