...
\noindent From the Bode plot of $G(s)$ below, what delay can be tolerated before the system becomes unstable?
\vspace{0.3in}

%\includegraphics[]{./Problem10figure}
\includegraphics[width=5in]{\mainfolder/LectureNotes/\lecturefolder/HomeworkProblems/Problem10figure}
