For the following feedback control system, we wish to decrease the effect of the disturbance on the output $y(t)$ by varying $K$. What choice of $K$ results in the smallest possible effect on $y(t)$ due to a ramp disturbance? Hint: the feedback system must be stable.
\begin{center}
...
\draw (4,0) node[sysblock] (G) {$\frac{s+1}{(s+5)}$};
