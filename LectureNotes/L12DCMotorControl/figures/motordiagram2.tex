...
\draw (4.75,-1) node (I) {\input{\mainfolder/DrawingElements/MechanicalElements/inertia2.tex}};
\draw (I) node {$J$};
\draw[->] (3.95,-1) ++(0,.5)  node[above=2pt] {$\theta$}  .. controls  ++(-.15,-.3) and ++(-.15,.3) ..  ++(0,-1);

%\draw[->] (4,-1) ++(0,.5) node[above=2pt] {$\tau_{m}$}  .. controls  ++(-.15,-.3) and ++(-.15,.3) ..  ++(0,-1);
%\draw[->] (5.75,-1) ++(0,.5)  node[above=2pt] {$\tau_{d}$}  .. controls  ++(.15,-.3) and ++(.15,.3) ..  ++(0,-1);
