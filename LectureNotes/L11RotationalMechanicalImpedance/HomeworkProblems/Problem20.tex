A tank has both an inlet and outlet valve. It is supplied at pressure $p_{in}$. Find the transfer function from input $p_{in}$ to output $p_{1}$. Use gauge pressure so that $p_{a}=0$. Use fluid density $\rho$ and gravitational acceleration $g$.\vspace{.1in}
\begin{center}
\begin{tikzpicture}
