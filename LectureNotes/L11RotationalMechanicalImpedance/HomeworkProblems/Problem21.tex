Find the transfer function for the following system if the input is $q_{in}$ and the output is $q_{out}$. Assume that $\rho g =1$. 
\begin{center}
\begin{tikzpicture}
...
\draw[<-] (pipe0.180) ++(.5,0) -- ++(-.5,0) node[left] {$q_{in}$};
