...
\draw (-4,1) node[draw,rectangle,very thick,minimum width=.5in,minimum height=.5in,outer sep=0pt] (C) {$K_{p}+\frac{K_{I}}{s}$};
...
\draw[<-] (pipe1.180) ++(1.1,0) --  ++(-.5,0) node[left] {$x=q_{in}$};
