...
\end{center}
Sketch the Nyquist plot. Based on the Nyquist stability criterion, determine if it is possible for the closed loop system to be stable, and if so the number of unstable poles that $G(s)$ would need to have.
