...
\draw[inner sep=0pt,outer sep=0pt,very thick] (3.5,0) node (D2) {\input{\mainfolder/DrawingElements/MechanicalElements/damper.tex}};
\draw (D1) node[below=14pt] {$b_{1}$};
\draw (D2) node[below=14pt] {$b_{2}$};
