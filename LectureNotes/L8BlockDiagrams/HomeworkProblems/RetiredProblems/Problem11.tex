...
\end{center}
\begin{enumerate}[(a)]
\item[(a)] Write down the equations (in terms of $R(s)$, $E(s)$, $A(s)$ and $Y(s)$) that this block diagram represents.
\item[(b)]  Simplify the block diagram to find $\frac{Y(s)}{R(s)}$.
\end{enumerate}
