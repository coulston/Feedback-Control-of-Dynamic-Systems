...
\draw (.75,0) node[above] (tank) {\input{../../../Tikzmodeling/FluidElements/tank.tex}};
...
\draw (2.65,1) node (pipe2) {\input{../../../Tikzmodeling/FluidElements/valve.tex}};
...
\draw (6,2) node[nosep,scale=.95] (I) {\input{../../../Tikzmodeling/CircuitElements/currentsource.tex}};
\draw (6,2) node[left=18pt] {$Q_{in}$};
\draw (8,2) node[rotate=90,nosep] (C) {\input{../../../Tikzmodeling/CircuitElements/capacitor.tex}}; 
\draw (8,2) node[right=18pt] {$\frac{A}{\rho g}$};
\draw (9.5,3.5) node[nosep] (R) {\input{../../../Tikzmodeling/CircuitElements/resistor.tex}}; 
