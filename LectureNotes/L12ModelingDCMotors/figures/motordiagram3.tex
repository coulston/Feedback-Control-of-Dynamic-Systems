...
\draw (6.5,-1) node (I) {\input{\mainfolder/DrawingElements/MechanicalElements/inertia2.tex}};
\draw (I) node {$J$};
...
\draw (5,-1) node (D) {\input{\mainfolder/DrawingElements/MechanicalElements/spring.tex}};
\draw (D) node[above=12pt] {$k$};
%\draw (7.5,-1) node[rotate=180] (gnd) {\input{../../../Tikzmodeling/MechanicalElements/ground.tex}};
